...
<main
  class="grid w-full bg-[hsla(285, 33%, 5%, 0.6)] mix-blend-difference bg-cover h-screen bg-gradient-to-tl from-[var(--heroBgColor)] 25% via-[hsl(292,69%,13%)] 35% to-[hsl(283,90%,78%)]">
  <Navbar />
  <slot />
</main>
