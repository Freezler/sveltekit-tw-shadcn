...
<div
  ...
  <div
    ...
    <div
      class="flex flex-col items-center justify-center border-2 border-red-500/25 rounded-xl max-w-2/3 bg-[hsla(256,53%,34%,0.5)]">
      <h1
...
<style>
 @layer --borderColor: hsla(256,53%,34%,0.5);
</style>
