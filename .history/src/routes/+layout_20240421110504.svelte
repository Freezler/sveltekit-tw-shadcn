...
:root {
  ...
  :root::view-transition-old(root) {
    animation:
       cubic-bezier(0.95, 0.05, 0.795, 0.035) both fade-out,
      cubic-bezier(0.95, 0.05, 0.795, 0.035) both slide-to-left;
  ...
  :root::view-transition-new(root) {
    animation:
     cubic-bezier(0.95, 0.05, 0.795, 0.035) both fade-in,
    cubic-bezier(0.95, 0.05, 0.795, 0.035) both slide-from-right;
      animation-duration: 320ms;
