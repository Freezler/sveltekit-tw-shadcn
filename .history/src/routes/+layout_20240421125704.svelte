...
<main
  class="grid w-full place-items-center bg-cover h-screen bg-gradient-to-br from-[rgba(0,0,0,0.9)] via-color to-[--grape]">
  <Navbar />
  <slot />
</main>
...
<style>
  ...
  section::view-transition-old(root) {
    animation:
      cubic-bezier(0.175, 0.885, 0.32, 1.275) both fade-out,
      cubic-bezier(0.175, 0.885, 0.32, 1.275) both slide-to-left;
    animation-duration: 800ms;
  }
  form::view-transition-new(root) {
    animation:
      cubic-bezier(0.175, 0.885, 0.32, 1.275) both fade-in,
      cubic-bezier(0.175, 0.885, 0.32, 1.275) both
        slide-from-right;
