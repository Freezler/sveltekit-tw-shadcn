<main>
  <section class="grid w-screen h-screen text-white place-items-center bg-indigo-950">
    <div class="flex-row p-8 mx-auto text-center">
      div.border-2 rounded-xl
      ...
      <div class="flex flex-row items-center justify-center w-full grid-rows-1 p-4">
      <ul class="p-4">
        <li>Item 1</li>
        <li>Item 2</li>
        <li>Item 3</li>
