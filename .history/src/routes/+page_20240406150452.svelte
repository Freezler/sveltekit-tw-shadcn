...
<div
  class="flex flex-col items-center justify-center h-screen bg-green-600 ">
  <AspectRatio
    ratio={16 / 9}
    class=" bg-muted">
    <img
      ...
      alt="alt"
      class="absolute top-0 bottom-0 left-0 right-0 h-full -translate-x-1/2 -translate-y-1/2 bg-cover" />
  </AspectRatio>
  <div
