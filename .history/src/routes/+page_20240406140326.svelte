...
<div
  class=" flex flex-col items-center justify-center w-[100vw] h-[screen] -z-10">
  <AspectRatio
    ratio={16 / 9}
    class="bg-red-300 w-[100vw] h-12">
    <img
  ...
  <h1
    class="text-2xl bg-red-300 w-[35ch] text-center">
