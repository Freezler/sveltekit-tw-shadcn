...
<main
  class="grid w-full bg-[hsla(285, 33%, 5%, 0.6)] mix-blend-difference bg-cover h-screen bg-gradient-to-tl from-[var(--heroBgColor)] via-[hsl(291,55%,30%)] to-[hsl(283,90%,78%)]">
  <Navbar />
  <slot />
</main>
