...
<main
  class="grid w-full bg-[hsla(285, 33%, 5%, 0.6)] mix-blend-difference bg-cover h-screen bg-gradient-to-tl from-[var(--heroBgColor)] 25% via-[#461050] 35% to-[hsl(283,90%,28%)]">
  <Navbar />
  <slot />
</main>
