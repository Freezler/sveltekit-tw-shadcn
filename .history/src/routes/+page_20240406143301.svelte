...
<div class="grid items-center justify-center min-h-screen bg-gradient-to-tr from-indigo-900 to-cyan-400">
  <AspectRatio
    ratio={16 / 9}
    class="w-screen bg-muted">
    <img
      ...
      alt="alt"
      class="object-cover w-full h-screen opacity-50" />
  </AspectRatio>
  <div
    class=" z-10 text-center p-2 text-[#181414] opacity-full">
    <h1
