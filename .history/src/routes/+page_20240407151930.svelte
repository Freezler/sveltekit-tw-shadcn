...
<div
  ...
  <div
    ...
    <div
      class="flex flex-col items-center justify-center border-2 border-red-500 h-2/4 max-w-screen bg-[hsla(0,0%,0%,0.5)]">
      <h1
      ...
      <p class="text-pretty text-">
        You can learn more
        about the project
        <Button
          variant="outline"
          class="bg-blue-200 hover:bg-blue-400"
          size="sm"
