...
<main
  class="grid w-screen place-items-center bg-cover h-screen bg-gradient-to-br from-[rgba(0,0,0,1)] via-color to-[--grape]">
  <Navbar />
  <slot />
</main>
...
<style>
  ...
  section::ComponentTransfer::view-transition-old(root) {
