    ...
    <nav
      ...
      <div
        ...
        <div
          ...
          <a class="text-white hover:text-blue-400" href="/" on:click={toggleNavbar} 
            >Home</a>
          <a class="text-white hover:text-blue-400" href="/blogs" on:click={toggleNavbar}
            >Blog</a>
          <a
