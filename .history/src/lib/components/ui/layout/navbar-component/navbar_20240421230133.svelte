  ...
  <div class="w-full h-full bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between">
        <svg
          class="filter rounded-full shadow-sm drop-shadow-[0_5px_8px_var(--fandango)] bg-blur-xs mb-2 hover:animate-pulse"
          ...
          ><g
            ...
            ><svg
              viewBox="0 0 396 141"
              data-background-color="rgba(72, 25, 160, 0.9)"
      ...
      <div
        class="absolute top-0 left-0 z-100 right-0 flex-col grid place-items-center justify-center items-center bg-blue-900/60 h-screen md:h-full md:bg-transparent md:flex md:flex-row md:items-center md:justify-center space-x-0 md:space-x-4 md:mx-auto {showMenu
          ...
          : 'hidden'}">
        <div
          class="font-larger text-[--off-white] flex flex-col py-6 w-[80vw] h-[60vh] items-center justify-center md:flex-row bg-stone-800/20 md:bg-transparent md:space-x-4 rounded-xl font-inter">
...
<style>
  ...
  svg {
    height: 64px;
    width: 64px;
    filter: drop-shadow(0 0 1.5rem rgba(79, 132, 207, 0.6));

    /* -8px -8px 11px -8px inset rgba(172, 25, 160, 0.9); */
    padding: 8px;
    ...
    border-radius: 64px;
    box-shadow: 11px 12px 13px 1px inset rgba(25, 96, 172, 0.4);
  }
  nav::after {
    max-width: 372px;
  ...
  a {
    background:
      linear-gradient(45deg, var(--palatinate-blue) 0 0) left var(--p, 50%) bottom
        0 / var(--d, 15%) 1px no-repeat,
      linear-gradient(var(--vivid-sky-blue) 0 0) right var(--p, 50%)
        bottom 0 / var(--d, 15%) 1px no-repeat;
    transition:
      0.3s,
