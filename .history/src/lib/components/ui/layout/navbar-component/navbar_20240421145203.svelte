  ...
  <div class="w-full bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between ">
        <svg
        class="filter drop-shadow-[0_0_16px_var(--chrysler-blue)] p-[1px] rounded-full shadow-sm drop-shadow-[0_0_16px_var(--chrysler-blue)]  h-11 w-11 shadow-neutral-50 bg-blur-lg mb-2 "
