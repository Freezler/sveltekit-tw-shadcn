      ...
      <div
        ...
        <div
          ...
          <a class="text-white hover:text-blue-400" href="/about"
            >About me</a>
          <a class="px-3 py-1 text-sm text-white border-2 rounded-md md:absolute bg-fuchsia-500/50 right-4 hover:text-blue-400" href="/"><button type="submit">Log in-or-sign up</button></a>
        </div>
      </div>
    </nav>
  </div>
