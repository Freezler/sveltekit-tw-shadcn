...
<div class="fixed top-0 left-0 z-50 w-full header">
  <div class="w-screen bg-transparent">
    <nav
      ...
      <div
        class="absolute top-0 left-0 z-100 right-0 md:blur-sm flex flex-col grid place-items-center justify-center items-center bg-blue-900/60 h-screen md:h-full md:bg-transparent md:flex md:flex-row md:items-center md:justify-center space-x-0 md:space-x-4 md:mx-auto {showMenu
          ? 'flex'
          : 'hidden'}">
        <div
