...
<style>
  ...
  @keyframes pulse {
    0% {
      box-shadow: 
        5px -5px 120px .5px var(--grape), 
        2px -6px 9px -4px inset rgba(172, 25, 160, 0.8);
      scale: 1;
      background-position: sta;
    }
    60% {
      box-shadow: 
        10px 15px -80px 0px var(--off-white), 
        -2px 6px 9px -4px inset rgba(172, 25, 160, 0.8);
      scale: 1.02;
    }
    100% {
      box-shadow: 
        15px -5px 120px .5px var(--vivid-sky-blue), 
        2px 12px 9px -9px inset rgba(172, 25, 160, 0.3);
      scale: 1;
    }
