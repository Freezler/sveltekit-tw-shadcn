    ...
    <nav
      ...
      <div
        ...
        <div
          ...
          <a class="text-white hover:text-blue-400" href="/" on:click={closeNavbar} 
            >Home</a>
          <a class="text-white hover:text-blue-400" href="/blogs" on:click={closeNavbar}
            >Blog</a>
          <a
            class="text-white hover:text-blue-400"
            href="/contact">Contact</a> on:click={closeNavbar}
