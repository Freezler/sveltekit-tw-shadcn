  ...
  <div class="w-full bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between">
        <svg
          class="filter rounded-full shadow-sm drop-shadow-[0_0_8px_var(--fandango)] h-11 w-11 shadow-neutral-50 bg-blur-xs mb-2"
...
<style>
  ...
  svg {
    box-shadow:
      -5px -5px 80px .5px var(--grape), 
      -2px -2px 9px -4px inset rgba(172, 25, 160, 0.8);
    padding: 4px;
    animation: cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.5s infinite;
    animation-name: pulse;
    animation-duration: 4.5s;
    animation-iteration-count: on;
  }
  nav::after {
    max-width: 372px;
  ...
  @keyframes pulse {
    0% {
      box-shadow: 
        5px -5px 200px 1.5px var(--grape), 
        2px -6px 9px -4px inset rgba(172, 25, 160, 0.8);
      scale: 1;
      background-position: center top 24px;
    }
    60% {
      box-shadow: 
        10px 15px 180px 0px var(--off-white), 
        -2px 6px 24px -4px inset rgba(172, 25, 160, 0.8);
      scale: 1.02;
      background-position: center right 124px;
    }
    100% {
      box-shadow: 
        -15px 5px 80px 1.5px var(goldenrod), 
        2px -12px 90px -4px inset rgba(172, 25, 160, 0.3);
      scale: 1;
    }
