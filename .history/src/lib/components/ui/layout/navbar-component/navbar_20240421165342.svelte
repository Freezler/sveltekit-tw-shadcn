...
<style>
 ...
 @keyframes pulse {
  0% {
    box-shadow: 
      10px 10px 50px 5px var(--grape), 
      2px 2px 4px -2px inset rgba(172, 25, 160, 0.8);
    scale: 1.1;
  }
  50% {
    box-shadow: 
      8px 8px 30px 5px var(--grape), 
      -1px -1px 2px -1px inset rgba(172, 25, 160, 0.9);
  }
  97% {
    box-shadow: 
      6px 6px 125px 3.5px var(--grape), 
      -1px -1px 2px -1px inset rgba(172, 25, 160, 0.8);
  }
}
</style>
