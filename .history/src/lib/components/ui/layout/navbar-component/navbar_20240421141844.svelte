  ...
  <div class="w-screen bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between">
        <svg
        class="after:duration-1000 ease-out after:block after:h-0.5 after:w-full after:origin-bottom-right after:scale-x-0 after:bg-red-500 after:transition-transform after:hover:origin-bottom-left after:hover:scale-x-100 p-2 rounded-full shadow-sm drop-shadow-[0_0_10px_var(--vivid-sky-blue)]  h-16 w-16 shadow-neutral-50 bg-blur-lg"
