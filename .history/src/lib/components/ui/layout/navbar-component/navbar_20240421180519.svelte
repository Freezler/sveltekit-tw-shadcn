...
<style>
  ...
  nav::after {
    ...
    a {
  background: 
    linear-gradient(currentColor 0 0) left  var(--p, 40%) bottom 0 /var(--d, 10%) 1px no-repeat,
    linear-gradient(currentColor 0 0) right var(--p, 40%) bottom 0 /var(--d, 10%) 1px no-repeat;
