    ...
    <nav
      ...
      <div
        class="absolute top-0 left-0 z-100 right-0 flex-col grid place-items-center justify-center items-center bg-blue-900/60 h-screen md:h-full md:bg-transparent md:flex md:flex-row md:items-center md:justify-center space-x-0 md:space-x-4 md:mx-auto {showMenu
          ...
          : 'hidden'}">
        <div
          class="font-larger text-[--off-white] flex flex-col py-6 w-[80vw] h-[60vh] items-center justify-center md:flex-row bg-stone-800/20 md:bg-transparent md:space-x-4 rounded-xl font-display">
...
<style>
  ...
  svg {
    ...
    border-radius: 64px;
    box-shadow: 1px 2px 20px 1px rgba(25, 96, 172, 0.4);
  }
  nav::after {
    max-width: 372px;
