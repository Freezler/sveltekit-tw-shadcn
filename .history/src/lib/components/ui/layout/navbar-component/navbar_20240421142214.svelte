...
<div class="fixed top-0 left-0 z-50 w-full header ">
  <div class="w-screen bg-transparent">
    <nav
      class="px-6 py-8 mx-auto md:flex md:justify-between md:items-end after:duration-1000 ease-out after:block after:h-0.2 after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[--vivid-sky-blue] after:transition-transform after:hover:origin-bottom-left after:hover:scale-x-95">
