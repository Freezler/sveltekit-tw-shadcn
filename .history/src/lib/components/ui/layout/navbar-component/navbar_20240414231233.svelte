      ...
      <div
        ...
        <div
          ...
          <a class="text-white hover:text-blue-400" href="/about"
            >About me</a>
          <a class="absolute px-3 py-1 text-white border-2 rounded-md bg-fuchsia-500/75 right-4 hover:text-blue-400" href="/log-signIn"><button type="submit">Log in/sign up</button></a>
        </div>
      </div>
    </nav>
  </div>
