...
<style>
  ...
  @keyframes pulse {
    ...
    90% {
     box-shadow: 
        15px -15px 100px 1.5px var(--palatinate-blue), 
        -0px 10px 24px -4px inset rgba(172, 25, 160, 0.8);
    ...
    99% {
    box-shadow: 
        -15px -25px 100px 0px var(--palatinate-blue), 
        -12px 16px 19px -14px inset rgba(172, 25, 160, 0.9);
