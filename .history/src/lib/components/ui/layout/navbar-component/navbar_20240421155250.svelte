  ...
  <div class="w-full bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between">
        <svg
          class="filter rounded-full shadow-sm drop-shadow-[0_0_8px_var(--fandango)] h-11 w-11 shadow-neutral-50 bg-blur-xs mb-2 bg-[--fandango] shadow-[0_0_8px_var(--fandango)]"
