...
<div class="fixed top-0 left-0 z-50 w-full header ">
  <div class="w-full bg-transparent">
    <nav
      class="px-6 py-4 mx-auto md:flex md:justify-between md:items-end after:duration-1000 ease-out after:block after:h-[1px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[--vivid-sky-blue] after:transition-transform after:hover:origin-bottom-left after:hover:scale-x-100">
      <div class="flex items-center justify-between ">
        <svg
        class=" p-2 rounded-full shadow-sm drop-shadow-[0_0_10px_var(--vivid-sky-blue)]  h-16 w-16 shadow-neutral-50 bg-blur-lg"
      ...
      <div
        ...
        <div
          ...
          <a class=" hover:text-blue-400" href="/"
            >Home</a>
          <a class=" hover:text-blue-400" href="/blogs"
            >Blog</a>
          <a
...
<style>
  ...
  nav:after {
    padding-top: 20px;
    width: 100%;
    mask-image: linear-gradient(to bottom, transparent 15%, rgb(178, 45, 45) 100%);
    z-index: 1000;
    filter: drop-shadow(10px 0 10px rgba(184, 69, 69, 0.5));
