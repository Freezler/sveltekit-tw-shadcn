...
<style>
  ...
  svg {
    ...
    padding: 4px;
    animation: cubic-bezier(0.215, 0.610, 0.355, 1) 1s;
  ...
  @keyframes pulse {
    ...
    99% {
      box-shadow: 
        10px 15px 180px 0px var(--palatinate-blue), 
        -2px 6px 24px -4px inset rgba(172, 25, 160, 0.7);
      scale: 1.15;
     
    }
    100% {
      box-shadow: 
        -15px 5px 80px -.5px var(--palatinate-blue), 
