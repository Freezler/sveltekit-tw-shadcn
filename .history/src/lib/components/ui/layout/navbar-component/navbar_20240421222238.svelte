  ...
  <div class="w-full h-full bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between">
        <svg
          class="filter rounded-full shadow-sm drop-shadow-[0_5px_8px_var(--fandango)] bg-blur-xs mb-2"
...
<style>
  ...
  svg {
    height: 64px;
    width: 64px;
    filter: drop-shadow(0 0 0.5rem rgba(154, 79, 207, 0.6));
    ...
    border-radius: 64px;
    box-shadow: 1px 2px 20px 1px rgba(172, 25, 160, 0.4);
  }
  nav::after {
    max-width: 372px;
