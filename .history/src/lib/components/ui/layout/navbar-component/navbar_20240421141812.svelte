...
<div class="fixed top-0 left-0 z-50 w-full header after:duration-1000 ease-out after:block after:h-0.5 after:w-full after:origin-bottom-right after:scale-x-0 after:bg-red-500 after:transition-transform after:hover:origin-bottom-left after:hover:scale-x-100">
