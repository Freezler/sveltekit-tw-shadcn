  ...
  <div class="w-full bg-transparent">
    <nav
      ...
      <div class="flex items-center justify-between">
        <svg
          class="filter rounded-full shadow-sm drop-shadow-[0_0_8px_var(--fandango)] h-11 w-11 shadow-fuchsia-800 bg-blur-xs mb-2"
...
<style>
  ...
  @keyframes pulse {
    ...
    100% {
      ...
      scale: 1.1;
      background-position: center bottom 324px;
      padding: 2px;
    }
